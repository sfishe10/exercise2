		...
		return html`
			<section class="content">
				...
				<section class="attraction-cards">
					<display-card imagePath="/images/bishop.webp" linkPath="./trails/bishop">
						<span slot="label">Bishop's Peak</span>
					</display-card>
					<display-card imagePath="/images/madonna.jpeg" linkPath="./trails/madonna">
						<span slot="label">Madonna Mountain</span>
					</display-card>
					<display-card imagePath="/images/p.jpeg" linkPath="./trails/p">
						<span slot="label">The P</span>
					</display-card>
				</section>
			</section>
		`
